 ...
 * @date 2018-09-17
 */
@WebServlet("/ticketsLog/obtertodosparadatatable")
public class TicketsLogObterTodosParaDatatable extends HttpServlet {

    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        HashMap<String, Object> resultado = new HashMap<>();
        List<HashMap<String, Object>> registros = new TicketsLogDAO().obterTodosParaDataTable();
