                    ...
                    <ul class="list-group">
                        ...
                        <div class="media">
                          <div class="pr-20">
                            <a class="avatar" href="javascript:void(0)">
                              <img class="img-fluid" src="./ProjetoFinal-Interno/tema/global/portraits/2.jpg"
                                alt="...">
                            </a>
                          </div>
                      ...
                      <li class="list-group-item">
                        <div class="media">
                          <div class="pr-20">
                            <a class="avatar" href="javascript:void(0)">
                              <img class="img-fluid" src="./ProjetoFinal-Interno/tema/global/portraits/3.jpg"
                                alt="...">
                            </a>
                          </div>
                          <div class="media-body">
                            ...
                            <div class="profile-brief clearfix">
                              <img class="profile-uploaded" src="./ProjetoFinal-Interno/tema/global/photos/placeholder.png" alt="...">
                              <img class="profile-uploaded" src="./ProjetoFinal-Interno/tema/global/photos/placeholder.png" alt="...">
                              <img class="profile-uploaded" src="./ProjetoFinal-Interno/tema/global/photos/placeholder.png" alt="...">
                              <img class="profile-uploaded" src="./ProjetoFinal-Interno/tema/global/photos/placeholder.png" alt="...">
                            </div>
                      ...
                      <li class="list-group-item">
                        <div class="media">
                          <div class="pr-20">
                            <a class="avatar" href="javascript:void(0)">
                              <img class="img-fluid" src="./ProjetoFinal-Interno/tema/global/portraits/4.jpg"
                                alt="...">
                            </a>
                          </div>
                          <div class="media-body">
                      ...
                      <li class="list-group-item">
                        <div class="media">
                          <div class="pr-20">
                            <a class="avatar" href="javascript:void(0)">
                              <img class="img-fluid" src="./ProjetoFinal-Interno/tema/global/portraits/5.jpg"
                                alt="...">
                            </a>
                          </div>
                          <div class="media-body">
                            ...
                            <div class="profile-brief">
                              <div class="media">
                                <a class="pr-20">
                                  <img class="w-160" src="./ProjetoFinal-Interno/tema/global/photos/placeholder.png" alt="...">
                                </a>
