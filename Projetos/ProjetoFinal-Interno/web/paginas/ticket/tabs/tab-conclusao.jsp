    ...
    <div class="example">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" disabled="disabled" autocomplete="off" value="<%= DateFormatador.timesStampFormatoBrSemHora(ticket3.getDataEncerramento())%>"/>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group row col-md-6">
                <div class="col-md-9">
                    <label class="form-control-label">Procedimento de Resolução</label>
                    <textarea class="form-control" disabled="disabled" autocomplete="off" value="<%= ticket3.getProcedimentoResolucao()%>"/></textarea>
                </div>
            </div>
        </div>
        <%}%>
