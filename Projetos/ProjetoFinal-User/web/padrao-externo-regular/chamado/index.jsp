                        ...
                        <ul class="color-selector">
                            ...
                            <div> 
                                <button type="button" class="btn btn-primary" id="inputStylePrimary" name="colorChosen" data-target="#exampleModalPrimary"
                                        data-toggle="modal"/>Iniciar</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="from-control select tags-select" name="tags[]" id="tags" multiple="multiple">

                                <%for (TagBean tag : tags) {%>
                                <option value="<%=tag.getId()%>"><%=tag.getTitulo()%></option>
                    ...
                    <div class="modal-footer">
                        <div class="col-md-12 float-right">
                            <button class="btn btn-primary" id="btn-cadastrar" data-dismiss="modal" type="submit"
